...
const Trading = ({
  ...
  const [userMembership, setUserMemebership] = useState();
  ...
  useEffect(() => {
    if (active) {
      const yourFunction = () => {
        ...
        console.log("Function called in every 1 minute.");
      };
                      ...
                      <div className="item">
                        ...
                        <h3 className="title">
                          {activeNetwork?.privateKey == undefined
                            ? "Select"
                            : shortenAddress(activeNetwork.privateKey)}
                          <span
                            onClick={() =>
                              navigator.clipboard.writeText(
