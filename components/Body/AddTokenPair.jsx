        ...
        <div className="techwave_fn_contact_page">
          ...
          <div className="contactpage">
            <div className="container small">
              <div className="fn_contact_form">
                <form className="contact_form">
                  <div className="input_list">
                    <ul>
                      ...
                      <li>
                        <input
                          type="text"
                          placeholder="Native Token Name 2"
                      ...
                      <li>
                        <input
                          type="text"
                          placeholder="Native Token 2 Address"
                          onChange={(e) =>
                  ...
                  <div
                    ...
                    data-success="Thanks for submitting the data!"
                  ></div>
                </form>
              </div>
              ...
              <p>
                Kindly add your tokens which you want to use for automatic
                trading
              </p>
            </div>
          </div>
